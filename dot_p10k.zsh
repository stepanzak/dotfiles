# Generated by Powerlevel10k configuration wizard on 2023-10-18 at 18:49 CEST.
...
# slanted separators, slanted heads, round tails, 2 lines, dotted, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%3F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%3F├─'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=3
    #240
  ...
  typeset -g POWERLEVEL9K_DIR_DOCUMENTS_VISUAL_IDENTIFIER_EXPANSION='󱔗 '
  ...
  typeset -g POWERLEVEL9K_DIR_VIDEOS_VISUAL_IDENTIFIER_EXPANSION='󰕧'
  typeset -g POWERLEVEL9K_DIR_HOME_TOP_LEVEL_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_HOME_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_OUTSIDE_HOME_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_OUTSIDE_HOME_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='  '
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='✔ ( 󰟥 ✘)'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=11
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION='󰜃 '
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_NNN_VISUAL_IDENTIFIER_EXPANSION='󱗁 nnn'
  ...
  typeset -g POWERLEVEL9K_VIM_SHELL_BACKGROUND=#019833
  # Custom icon.
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_CHEZMOI_SHELL_VISUAL_IDENTIFIER_EXPANSION=' chz'
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=#019833
  ...
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_BACKGROUND=15
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_FOREGROUND=0
  # Context color in SSH with privileges.
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_SUDO_FOREGROUND=15
  ...
  typeset -g POWERLEVEL9K_NODENV_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_NODEENV_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=239
  # Custom icon.
